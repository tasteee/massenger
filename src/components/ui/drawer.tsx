	...
	return (
		<DrawerPortal data-slot="drawer-portal">
			...
			<DrawerPrimitive.Content
				...
				className={cn(
					'group/drawer-content bg-surface-elevated fixed z-50 flex h-auto flex-col border',
				...
				{...props}
			>
				<div className="bg-muted mx-auto mt-4 hidden h-2 w-[100px] shrink-0 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block opacity-50" />
				{children}
			</DrawerPrimitive.Content>
		</DrawerPortal>
	)
