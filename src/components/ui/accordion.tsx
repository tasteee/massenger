	...
	return (
		<AccordionPrimitive.Header className="flex">
			<AccordionPrimitive.Trigger
				...
				className={cn(
					'focus-visible:border-ring focus-visible:ring-brand-accent/50 focus-visible:ring-[3px] focus-visible:border-brand-accent focus-visible:outline-none/50 flex flex-1 items-center justify-between gap-4 rounded-[var(--radius-lg)] px-4 py-4 text-left text-sm font-medium transition-smooth outline-none hover:bg-surface-active disabled:pointer-events-none disabled:opacity-50 [&[data-state=open]>svg]:rotate-180',
					className
				)}
				{...props}
			>
